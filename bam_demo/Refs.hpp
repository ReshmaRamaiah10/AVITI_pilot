...
class Refs {
 public:
	...
	int getM() const { return M; } // get number of sequences
	void setM(int M) { this->M = M; seqs.resize(M); } 
 ...
 private:
	int M; // # of sequences, id starts from 0
	std::vector<RefSeq> seqs;  // reference sequences
};
